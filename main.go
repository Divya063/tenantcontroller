...
func main() {
	...
	err = (&controllers.TenantNamespaceReconciler{
		Client: mgr.GetClient(),
	...
	err = (&controllers.TenantRoleBindingReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("TenantRoleBinding"),
	}).SetupWithManager(mgr)
	if err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "TenantRoleBinding")
		os.Exit(1)
	}
